...
( function( $, api ) {
    ...
    api.controlConstructor['blog-decode-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['blog-decode-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#blog-decode-img-container li label img').click(function(){       
    //     $('#blog-decode-img-container li').each(function(){
    //         $(this).find('img').removeClass ('blog-decode-radio-img-selected') ;
    //     });
    //     $(this).addClass ('blog-decode-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', blog_decode_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', blog_decode_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', blog_decode_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #blog-decode-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #blog-decode-img-container li').each(function(){
            $(this).find('img').removeClass ('blog-decode-radio-img-selected') ;
        });
        $(this).addClass ('blog-decode-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #blog-decode-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #blog-decode-img-container li').each(function(){
            $(this).find('img').removeClass ('blog-decode-radio-img-selected') ;
        });
        $(this).addClass ('blog-decode-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #blog-decode-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #blog-decode-img-container li').each(function(){
            $(this).find('img').removeClass ('blog-decode-radio-img-selected') ;
        });
        $(this).addClass ('blog-decode-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #blog-decode-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #blog-decode-img-container li').each(function(){
            $(this).find('img').removeClass ('blog-decode-radio-img-selected') ;
        });
        $(this).addClass ('blog-decode-radio-img-selected') ;
    });    

    function blog_decode_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            blog_decode_customize_multi_write( $control );
    }

    function blog_decode_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        blog_decode_customize_multi_write( $control );
    }

    function blog_decode_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function blog_decode_customize_multi_write( $element) {
