...
class Blog_Decode_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blog-decode-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Blog_Decode_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Blog_Decode_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Blog_Decode_Note_Control extends WP_Customize_Control {
